 ...
 */
export async function generateHash(data: TransactionData, parentHash: string): Promise<string> {
 ...
 */
export async function validateBlock(block: Block, parentHash: string): Promise<boolean> {
